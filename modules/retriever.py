...
class ScientificKnowledgeBase:
    ...
    def load_and_index_documents(self) -> int:
        ...
        No-ops if the persistent collection is already populated, so
        restarting the server does not duplicate every chunk on top of
        itself. Pass force=True (or clear vectordb_dir) to re-index.
        """
        try:
            existing = self.get_collection_stats()
            if existing.get("count", 0) > 0:
                logger.info(
                    f"Knowledge base already indexed ({existing['count']} chunks). Skipping re-index."
                )
    ...
    def _create_sample_knowledge(self) -> List[Document]:
        ...
        samples = [
            ...
            Document(
                ...
                metadata={"source": "FAO Global Soil Partnership – Soil Organic Carbon", "topic": "Soil Health", "year": 2023}
            ),
            Document(
                ...
                metadata={"source": "FAO Global Soil Partnership – Soil Organic Carbon", "topic": "Soil Health", "year": 2022}
            ),
            ...
            Document(
                ...
                metadata={"source": "IPCC AR6 – Climate Change and Land", "topic": "Rainfall Patterns", "year": 2024}
            ),
            Document(
                ...
                metadata={"source": "UNEP – Ecosystem-Based Adaptation Guidance", "topic": "Ecosystem Health", "year": 2021}
            ),
            ...
            Document(
                ...
                metadata={"source": "IPBES Global Assessment Report on Biodiversity and Ecosystem Services", "topic": "Agriculture", "year": 2023}
            ),
            Document(
                ...
                metadata={"source": "IPBES Global Assessment Report on Biodiversity and Ecosystem Services", "topic": "Soil Microbiology", "year": 2020}
            ),
            ...
            Document(
                ...
                metadata={"source": "World Agroforestry Centre (ICRAF)", "topic": "Agroforestry", "year": 2022}
            ),
            Document(
                ...
                metadata={"source": "World Agroforestry Centre (ICRAF)", "topic": "Climate Mitigation", "year": 2021}
            ),
            ...
            Document(
                ...
                metadata={"source": "IPBES Assessment Report on Pollinators, Pollination and Food Production", "topic": "Pollinator Conservation", "year": 2023}
            ),
            Document(
                ...
                metadata={"source": "IPBES Assessment Report on Pollinators, Pollination and Food Production", "topic": "Ecology", "year": 2020}
            ),
            ...
            Document(
                ...
                metadata={"source": "IPBES Global Assessment Report on Biodiversity and Ecosystem Services", "topic": "Biodiversity Loss", "year": 2022}
            ),
            Document(
                ...
                metadata={"source": "IPCC AR6 – Climate Change and Land", "topic": "Climate Systems", "year": 2021}
            ),
            ...
            Document(
                ...
                metadata={"source": "FAO Conservation Agriculture Guidelines", "topic": "Sustainable Agriculture", "year": 2024}
            ),
            Document(
                ...
                metadata={"source": "FAO Conservation Agriculture Guidelines", "topic": "Soil Health", "year": 2023}
            ),
            ...
            Document(
                ...
                metadata={"source": "IPBES Global Assessment Report on Biodiversity and Ecosystem Services", "topic": "Landscape Ecology", "year": 2021}
            ),
            Document(
                ...
                metadata={"source": "IPBES Global Assessment Report on Biodiversity and Ecosystem Services", "topic": "Conservation Biology", "year": 2022}
            ),
            ...
            Document(
                ...
                metadata={"source": "IPCC AR6 – Impacts, Adaptation and Vulnerability", "topic": "Climate Change", "year": 2023}
            ),
            Document(
                ...
                metadata={"source": "IPCC AR6 – Impacts, Adaptation and Vulnerability", "topic": "Climate Ecology", "year": 2022}
            ),
            ...
            Document(
                ...
                metadata={"source": "UNEP – Freshwater Ecosystems and Water Quality", "topic": "Aquatic Ecosystems", "year": 2021}
            ),
            Document(
                ...
                metadata={"source": "UNEP – Freshwater Ecosystems and Water Quality", "topic": "Bioindication", "year": 2020}
            ),
            ...
            Document(
                ...
                metadata={"source": "FAO/CGIAR Soil Microbiome Research", "topic": "Plant Pathology", "year": 2023}
            ),
            Document(
                ...
                metadata={"source": "FAO/CGIAR Soil Microbiome Research", "topic": "Symbiosis", "year": 2024}
            ),
            ...
            Document(
                ...
                metadata={"source": "UNEP – Urban Ecosystems and Green Infrastructure", "topic": "Urban Ecology", "year": 2022}
            ),
            Document(
                ...
                metadata={"source": "UNEP – Urban Ecosystems and Green Infrastructure", "topic": "Reconciliation Ecology", "year": 2021}
            )
        ]
        return samples
